...
class LandingpageController extends CI_Controller {
	...
	public function saveData() {
		...
		$index = array_search($code, $COUNTRY_CODES);
		$country = $COUNTRY_NAMES[$index];

		$query = "SELECT * FROM tbldata WHERE email = '$email'";
		$result = $this->db->query($query)->num_rows();
		if ($result > 0) {
			$query = "UPDATE tbldata SET fullname='$name',address='$address',phone='$phone',ip='$ip',country='$country',modified_date='$datetime' WHERE email='$email'";
		} else {
			$query = "INSERT INTO tbldata VALUES(NULL,'$name','$address','$email','$phone','$ip','$country','$datetime','$datetime','')";
		}
